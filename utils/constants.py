...
dir_path =  "/media/ula/DATADRIVE1/fos_gfp_tmaze/fos_gfp_tmaze2/sca_tifs/retrieval/ready_to_process/despeckle/"
...
CTX_REGIONS = [[5,1], [8,1], [10,1], [13,1], [11,2],[14,1],[20,2]]
# np.array([[5,1],[5,2],[5,3],[8,1],[8,2],[10,1],[10,2], [10,3],
...
LANDMARK_REGIONS = [[1,1],[3,1], [4,1], [6,1], [7,1],[9,1]]
# [[1,1],[1,2],[3,1],[3,2],[4,1],[4,2],[6,1],[6,2], [7,1], [7,2], 
#                [7,3], [9,1],[9,2], 
